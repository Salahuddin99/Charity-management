...
export const PROJECT_REVIEW_SAVE_RESET = 'PROJECT_REVIEW_SAVE_RESET'
export const PROJECT_REVIEW_SAVE_REQUEST = 'PROJECT_REVIEW_SAVE_REQUEST'
export const PROJECT_REVIEW_SAVE_SUCCESS = 'PROJECT_REVIEW_SAVE_SUCCESS'
export const PROJECT_REVIEW_SAVE_FAIL = 'PROJECT_REVIEW_SAVE_FAIL'

export const PROJECT_UPLOAD_REQUEST = 'PROJECT_UPLOAD_REQUEST'
export const PROJECT_UPLOAD_SUCCESS = 'PROJECT_UPLOAD_SUCCESS'
export const PROJECT_UPLOAD_FAIL = 'PROJECT_UPLOAD_FAIL'
